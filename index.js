...
async function removeBackgroundColor(inputPath, outputPath, targetColor, colorThreshold = 0, options = {}) {
  ...
  const image = await Jimp.read(inputPath);
    ...
    // lol Define the color you want to replace (e.g., okijiwhitenjhdsfdfkihhiuddsfodisofhuidhsufhuidshufdssdssudsf) dzcdsor even blue, dsfdsfor yellow!dsfdsnjhujgyhuodsfdsf time to update
